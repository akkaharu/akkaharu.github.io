    ...
    <div className="App">
      {
        superheroes.map(card => 
          <Card name={card.name} url={card.url} universe={card.universe} alterEgo={card.alterEgo} activity={card.activity} friends={card.friends} Superpowers={card.Superpowers} More={card.More}></Card>)
      }
    </div>
  );
}
